...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'produk' | 'kategori' | 'pembelian' | 'detailPembelian' | 'reservasi'
  ...
  export interface KategoriDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
     * // Only select the `KategoriID`
     * const kategoriWithKategoriIDOnly = await prisma.kategori.findMany({ select: { KategoriID: true } })
     * 
    **/
  ...
  export interface Prisma__KategoriClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    Produk<T extends Kategori$ProdukArgs<ExtArgs> = {}>(args?: Subset<T, Kategori$ProdukArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ProdukPayload<ExtArgs>, T, 'findMany'> | Null>;
  ...
  interface KategoriFieldRefs {
    readonly KategoriID: FieldRef<"Kategori", 'Int'>
  ...
  export type KategoriWhereInput = {
    ...
    KategoriID?: IntFilter<"Kategori"> | number
  ...
  export type KategoriScalarWhereWithAggregatesInput = {
    ...
    KategoriID?: IntWithAggregatesFilter<"Kategori"> | number
